        ...
        <div class="main-content3">
            <?php
                echo "<div class='right-column'>";
                    echo "<div class='right-card'>";
                        echo "<div class='img-wrapper'>";
                          echo"<img src='assets/img-leisure-resort/".$_SESSION['locationCodeOrig']."/a.jpg' class='right-img'>";
                        echo "</div>";
                ...
                echo "<div class='left-column'>";
                    ...
                    $i=1;
                    $count=2;
                    echo "<form action='leisure-and-resorts-4.php' method='post'>";
                    ...
                    for($i=1;$i<=$ADULT;$i++)
                    {
                        ...
                        echo "<input type='text' placeholder='Enter Full Name' name='fn[]' class='input-name' required>";
