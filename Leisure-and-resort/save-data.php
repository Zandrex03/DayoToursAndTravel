<?php
    ...
    $res = mysqli_query($connection,"SELECT * from tour_leisure_and_resort_1 where location_adv_name = '$locationName' ");
    $r = mysqli_fetch_assoc($res);
    $locationCode = $r['lnr_adv_code']; 
    ...
    echo "<script>window.location.href='leisure-resort-success.php'</script>";
?>