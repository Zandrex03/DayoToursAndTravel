        ...
        <div class="main-container2">
            <?php
                ...
                echo '<div class="title-content">';
                    ...
                    $result1 = mysqli_query($connection,"SELECT * FROM tour_outdoor_adventure_1 where location_adv_name='$selected'");
                    ...
                    $result2 = mysqli_query($connection,"SELECT * FROM tour_outdoor_adventure_2 where location_code='$lcode'");
                    $row2 = mysqli_fetch_assoc($result2);
                    $result3 = mysqli_query($connection,"SELECT * FROM tour_outdoor_adventure_3 where location_code='$lcode'");
                ...
                echo '<div class="image-box">';
                    echo" <div class='slideshow-container'>
                                ...
                                <img src='assets/img-outdoor-adv/". $row1['location_adv_code']."/a.jpg' style='width:100%' class='slide-img'>
                                </div>

                                <div class='mySlides fade'>
                                <div class='numbertext'>2 / 4</div>
                                <img src='assets/img-outdoor-adv/". $row1['location_adv_code']."/b.jpg' style='width:100%' class='slide-img'>
                                </div>

                                <div class='mySlides fade'>
                                <div class='numbertext'>3 / 4</div>
                                <img src='assets/img-outdoor-adv/". $row1['location_adv_code']."/c.jpg' style='width:100%' class='slide-img'>
                                </div>

                                <div class='mySlides fade'>
                                <div class='numbertext'>4 / 4</div>
                                <img src='assets/img-outdoor-adv/". $row1['location_adv_code']."/d.jpg' style='width:100%' class='slide-img'>
                                </div>
            ...
            <div class="middle-content-container">
                <div class="right-container">
                    <div class="travel-form-wrapper">
                        <form action='book-outdoor-3.php' method="post">
                ...
                <div class="left-container">
                    <?php
                        ...
                        echo "<br>";
                        echo "<i class='fas fa-car-side'></i><span>Travel Type: <span/><b>". $row1['location_type']."</b>";
                        echo "<br>";
                        echo "<i class='fas fa-clipboard-check'></i><span>Availability: <span/><b>".$row1['availability']."</b>";
                        echo "<br>";
                        echo "<i class='fas fa-stopwatch'></i><span>Call Time: <span/><b>".$row1['calltime']."</b>";
                        echo "<br>";
                        echo "<i class='fas fa-clock'></i>Duration: <b>".$row1['duration']."</b>";
                        echo "<br>";
                        echo "<i class='far fa-language'></i><span>Language: <span/><b>".$row1['language']."</b>";
                        echo "<br>";
                        echo "<i class='fas fa-wifi'></i><span>Wifi: <span/><b>".$row1['wifi']."</b>";
                        echo "<br>";
                        echo "<i class='fas fa-user'></i><span>Minimum Age: <span/><b>".$row1['minimumage']."</b>";
                        echo "<br>";
                        echo "<i class='fas fa-dog-leashed'></i><span>Pets Allowed: <span/><b>".$row1['petsallowed']."</b>";
                        echo "<br>";
                        echo "<i class='fas fa-gifts'></i><span>Open for Parties or Event: <span/><b>".$row1['openforpartyevent']."</b>";
                        echo "<br>";
                        echo "<i class='fas fa-vial vial1'></i><span>COVID-19 Protocol Requirements: <span/><b>".$row1['covidreq']."</b>";
                        echo "<br>";
                        echo "<i class='fas fa-phone-square-alt'></i><span>Contact Phone Number: <span/><b>".$row1['contact_number']."</b>";
                        echo "<br>";
                        echo "<i class='fas fa-at'></i><span>Contact Email Address: <span/><b>".$row1['contact_email']."</b>";
                        echo "<br><br><br>";

                    

                        echo "<h2 class='activity-title'>Activities</h2>";
                        $a="Flying";
                        echo "<i class='fas fa-running'></i><span>".$row2['act1']."</span><i class='fas fa-utensils'></i><span>".$row2['act2']."</span><i class='fas fa-swimming-pool'></i><span>".$row2['act3']."</span>";
                        echo "<br><br><h2 class='activity-title'>What To Bring</h2>";
                        echo "<i class='fas fa-qrcode'></i>".$row2['whattobring1']."<br>";
                        echo "<i class='fas fa-file-medical'></i>".$row2['whattobring2']."<br>";
                        echo "<i class='fas fa-vial vial2'></i>".$row2['whattobring3']."<br>";
                        echo "<i class='fas fa-mask'></i>".$row2['whattobring4']."<br>";
                        echo "<i class='fas fa-id-card'></i>".$row2['whattobring5']."<br>";
                        echo "<br><h2 class='activity-title'>Things to Know | Inclusion | Reminders <br><br></h2>";
