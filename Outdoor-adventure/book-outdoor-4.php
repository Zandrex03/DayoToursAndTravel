<?php
  ...
  $pay = $_SESSION['amounttopay'];
  if(isset($_POST['submitGC'])){
    $inpAmount = $pay;
    $ser = $_POST['serial-key'];

    $result = mysqli_query($connection,"SELECT * FROM payment_gift_cards WHERE amount = $inpAmount AND serial_key = '$ser' AND gc_status = 'A' ");
...
<body>
    ...
    <div class="book-navbar">
      <img src="assets/logoDayo3.jpg" alt="Dayo tours logo" class="navbar-logo"  onclick="window.location.href='../landingPage/index.php'">
    </div>
      ...
      <div class="main-content4">
        <?php
          ...
          echo "<div class='left-column'>";
            echo "<i class='fas fa-chevron-left' id='book-four-chevron'></i>";
            ...
            echo "<span class='book4-detail'>Account Name: </span>";
            echo $accountname = strtoupper($_POST['lname']) . ", ". ucfirst($_POST['fname']). " ". ucfirst($_POST['mname']);
            echo "<br>";
            echo "<span class='book4-detail'>Contact Number: </span>";
            echo $contact;
            echo "<br>";
            echo "<span class='book4-detail'>Email: </span>";
            echo $email;
            echo "<br><br>";
         ...
         <div class="right-column">
            <div class="red box">
              <div class="button-container">
                <button class="btn-1"><img src="assets/paypalLogo.png" alt="Paypal Logo" class="paypal-logo"></button>
                <button class="btn-2"><img src="assets/dragonpayLogo.png" alt="Dragon Pay Logo" class="dragon-pay-logo"></button>
              </div>
              <div class="box-content">
                <div id="smart-button-container">
                <div>
                  <h4 for="description" class="card-name">Card Holders Name : </h4>
                ...
                <div>
                  <h4 for="amount" class="card-name">Total Amount to be paid : </h4>
            ...
            <div class="voucher-container">
              <div class="voucher-title">
               ...
               <input type="text" class="voucher-code" placeholder="&#xF3FF; Use Voucher Code" style="font-family: Arial, 'Font Awesome 5 Free'">
            ...
            <div class="gift-container">
              ...
              <input type="text" class="voucher-code" placeholder="&#xF3FF; Use Gift Card" style="font-family: Arial, 'Font Awesome 5 Free'">
              <button class="apply-btn">Apply</button>
            </div>
          </div>
      </div>
  ...
  <script>
   //back button
   const backBtn = document.querySelector('#book-four-chevron');

   backBtn.addEventListener('click', () => {
      window.location="http://localhost/DayoTravelAndToursWebsite4.0/Outdoor-adventure/outdoor-adventures.php";
   });
   ...
   // payment method javascript
      ...
      btn1.style.borderBottom = "6px solid #00abae";
      btn1.style.background = "#f1f1f1";
      btn2.style.background = "white";
      boxContent.style.display = "block";
      btn2.style.borderBottom = "none";
      boxContent2.style.display = "none"
      });

      btn2.addEventListener("click", () => {
      btn2.style.borderBottom = "6px solid #00abae";
      btn2.style.background = "#f1f1f1";
      btn1.style.background = "white";
      boxContent2.style.display = "block";
