...
<head>
    ...
    <title>Outdoor Adventures | DAYO PH</title>
    <style>
    <?php
  ...
  ?>
    ...
    <div class="main-container">
       <div class="hero-section">
          <video muted autoplay="true" loop="true" class="outdoor-video">
            <source src="assets/outdoor.mp4" type="video/mp4">
          </video>
            <div class="headline">
               <h1>Be Adventourous in </h1>
        ...
        <div class="main-content">
          <?php
            ...
            // echo "<button><a href='../book/book.php'>Back to Book Type</a></button><br>";
                $result = mysqli_query($connection,"SELECT * FROM tour_outdoor_adventure_1");
              ...
              echo "<div class='box-container'>";
                echo "<div class='main-box'>";
                    echo "<div class='picture-box'>";
                      echo "<form action='book-outdoor-2.php' method='get' target='_blank'>";
                      echo "<img src='assets/img-outdoor-adv/". $row['location_adv_code']."/a.jpg' style='width:100%'>";
                    echo "</div>";
