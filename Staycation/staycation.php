...
<head>
    ...
    <title>Staycation Places | DAYO PH</title>
    <style>
    <?php
...
<body>
  ...
  ?>
    ...
    <div class="hero-section">
          <video muted autoplay="true" loop="true" class="hotel-video">
            <source src="assets/hotelVideo.mp4" type="video/mp4">
          </video>
            <div class="headline">
        ...
        <div class="main-content">
          <?php
            ...
            // echo "<button><a href='../book/book.php'>Back to Book Type</a></button><br>";
                $result = mysqli_query($connection,"SELECT * FROM tour_hotel_1");
              ...
              echo "<div class='box-container'>";
                echo "<div class='main-box'>";
                    echo "<div class='picture-box'>";
                      echo "<form action='staycation-2.php' method='get' target='_blank'>";
                      echo "<img src='assets/img-staycation/". $row['location_adv_code']."/a.jpg' style='width:100%'>";
                    echo "</div>";
