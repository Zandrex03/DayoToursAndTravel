        ...
        <div class="main-container2">
            <?php
                ...
                echo '<div class="title-content">';
                    ...
                    $result1 = mysqli_query($connection,"SELECT * FROM tour_packages_1 where location_adv_name='$selected'");
                    ...
                    $result2 = mysqli_query($connection,"SELECT * FROM tour_packages_2 where location_code='$lcode'");
                    $row2 = mysqli_fetch_assoc($result2);
                    $result3 = mysqli_query($connection,"SELECT * FROM tour_packages_3 where location_code='$lcode'");
                ...
                echo '<div class="image-box">';
                    echo" <div class='slideshow-container'>
                                ...
                                <img src='assets/img-package/". $row1['location_adv_code']."/a.jpg' style='width:100%' class='slide-img'>
                                </div>

                                <div class='mySlides fade'>
                                <div class='numbertext'>2 / 4</div>
                                <img src='assets/img-package/". $row1['location_adv_code']."/b.jpg' style='width:100%' class='slide-img'>
                                </div>

                                <div class='mySlides fade'>
                                <div class='numbertext'>3 / 4</div>
                                <img src='assets/img-package/". $row1['location_adv_code']."/c.jpg' style='width:100%' class='slide-img'>
                                </div>

                                <div class='mySlides fade'>
                                <div class='numbertext'>4 / 4</div>
                                <img src='assets/img-package/". $row1['location_adv_code']."/d.jpg' style='width:100%' class='slide-img'>
                                </div>
            ...
            <div class="middle-content-container">
                <div class="right-container">
                    <div class="travel-form-wrapper">
                        <form action='tour-package-3.php' method="post">
                ...
                <div class="left-container">
                    <?php
                        ...
                        echo $selected=$_GET['sel'];
                        echo "</h2>";
                        echo "<br><i><b>Locations: <br></b></i>";
                        echo "<p class='description-left' style='text-align: justify; text-justify: inter-word;'>".str_replace('|', '<br>',$row1['locations'])."</p>";
                        echo "<br>";
