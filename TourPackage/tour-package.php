...
<head>
    ...
    <title>Tour Package | DAYO PH</title>
    <style>
    <?php
  ...
  ?>
    ...
    <div class="hero-section">
          <video muted autoplay="true" loop="true" class="outdoor-video">
            <source src="assets/tourVideo.mp4" type="video/mp4">
          </video>
            <div class="headline">
               <h1>Packaged Trip</h1>
               <h1>For Your Best Experience</h1>
            </div>
        </div>
        <div class="main-content">
          <?php
            ...
            // echo "<button><a href='../book/book.php'>Back to Book Type</a></button><br>";
                $result = mysqli_query($connection,"SELECT * FROM tour_packages_1");
              ...
              echo "<div class='box-container'>";
                echo "<div class='main-box'>";
                    echo "<div class='picture-box'>";
                      echo "<form action='tour-package-2.php' method='get' target='_blank'>";
                      echo "<img src='assets/img-package/". $row['location_adv_code']."/a.jpg' style='width:100%'>";
                    echo "</div>";
